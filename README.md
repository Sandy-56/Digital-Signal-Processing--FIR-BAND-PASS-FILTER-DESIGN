...
n=0:1:N-1; 
hd=(sin(Wc1*(n-alpha+eps))-sin(Wc2*(n-alpha+eps)*pi))./((nalpha+eps)*pi)
...
## OUTPUT:
<img width="705" height="546" alt="image" src="https://github.com/user-attachments/assets/63f469b8-d905-47f0-8aca-66d2d47bdde2" />


## RESULT:
Thus the design of Band pass FIR digital filter using Blackman waveforms were 
